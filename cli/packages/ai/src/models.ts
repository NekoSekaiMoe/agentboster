...
export class Models {
  ...
  registerProvider(): void {
    throw new ModelsError(
      'no_provider',
      'Cannot register providers in this fork.',
    );
  }
  stream(..._args: unknown[]): never {
    throw new ModelsError(
      'no_provider',
      'Models.stream is stubbed; use the Agentboster adapter.',
    );
  }
  streamSimple(..._args: unknown[]): never {
    throw new ModelsError(
      'no_provider',
      'Models.streamSimple is stubbed; use the Agentboster adapter.',
    );
  }
  complete(..._args: unknown[]): never {
    throw new ModelsError(
      'no_provider',
      'Models.complete is stubbed; use the Agentboster adapter.',
    );
  }
  completeSimple(..._args: unknown[]): never {
    throw new ModelsError(
      'no_provider',
      'Models.completeSimple is stubbed; use the Agentboster adapter.',
    );
  }
  getApiKeyAndHeaders(
    ..._args: unknown[]
    ...
    return Promise.resolve({
      ok: false,
      error:
        'Models.getApiKeyAndHeaders is stubbed; auth lives on the web backend.',
    });
  }
}
