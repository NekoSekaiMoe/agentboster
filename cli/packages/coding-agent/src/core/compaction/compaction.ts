...
import { completeSimple } from '@agentboster-cli/ai/compat';
import {
  convertToLlm,
...
import {
  SUMMARY_PROMPT_INITIAL as SUMMARIZATION_PROMPT,
  SUMMARY_PROMPT_UPDATE as UPDATE_SUMMARIZATION_PROMPT,
} from './core.ts';
...
// SUMMARIZATION_PROMPT / UPDATE_SUMMARIZATION_PROMPT are imported at top of file
