...
declare module '@agentboster-cli/tui' {
...
export const KEYBINDINGS = {
  ...
  'app.mode.cycle': {
    defaultKeys: 'ctrl+t',
    description: 'Cycle input mode (normal / plan)',
  },
  'app.thinking.cycle': {
    defaultKeys: [], // moved to /effort + settings; no default key
  ...
  'app.tree.editVersion': {
    defaultKeys: 'e',
    description:
      'Edit the current version of the selected user message and resend',
  },
