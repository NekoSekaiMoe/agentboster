...
import {
  highlight,
  supportsLanguage,
} from '../../../utils/syntax-highlight.ts';
...
export interface TerminalAutoThemeDetector
  extends TerminalBackgroundThemeDetector {
...
export interface TerminalBackgroundThemeDetectionOptions
  extends TerminalThemeDetectionOptions {
...
export function detectTerminalBackgroundFromEnv(
...
const THEME_KEY = Symbol.for('@agentboster-cli/core:theme');
