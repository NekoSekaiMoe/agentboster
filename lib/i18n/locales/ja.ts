...
export const ja = {
  ...
  'config.trace.eventsOrdered': '{count} 件のイベント（開始時刻順）',
  'config.trace.failureCount': '失敗 {count} 件',
  ...
  'config.trace.modelCount': 'モデル {count} 件',
  ...
  'config.trace.toolCount': 'ツール {count} 件',
