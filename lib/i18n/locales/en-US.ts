export const enUS = {
  ...
  'config.trace.eventsOrdered': '{count} events, ordered by start time',
  'config.trace.failureCount': '{count} failures',
  ...
  'config.trace.modelCount': '{count} model',
  ...
  'config.trace.toolCount': '{count} tools',
