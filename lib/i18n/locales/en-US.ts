export const enUS = {
  ...
  'workspace.privateConfirmTitle': 'Make this workspace private?',
  'workspace.privateConfirmDescription':
    'Making "{name}" private revokes every member\'s access. The shared memory pool is deleted, and sessions members shared with the workspace become private to their creators again.',
  'workspace.detail.sharingTitle': 'Sharing',
  'workspace.detail.sharedMemoryTitle': 'Shared memory pool',
  'workspace.detail.sharedMemoryDescription':
    'When enabled, memories extracted in this workspace are visible to every member. Turning this off deletes the shared pool; personal memories are kept.',
  'workspace.detail.sharedMemoryOn': 'Enabled',
  'workspace.detail.sharedMemoryOff': 'Disabled',
  'workspace.detail.sharedMemorySuccess': 'Shared memory setting updated',
  'workspace.detail.sharedMemoryError':
    'Failed to update shared memory setting',
  'workspace.detail.sharedMemoryDisableConfirmTitle':
    'Disable the shared memory pool?',
  'workspace.detail.sharedMemoryDisableConfirmDescription':
    'Disabling deletes every shared memory in this workspace. Personal memories of each member are not affected.',
  'workspace.detail.sessionsTitle': 'Sessions',
  'workspace.detail.sessionsEmpty': 'No sessions in this workspace yet.',
  'workspace.detail.sessionUntitled': 'Untitled',
  'workspace.detail.sessionSharedBadge': 'Shared',
  'workspace.detail.sessionManageOnlyBadge': 'Manage only',
  'workspace.detail.sessionOpen': 'Open session',
  'workspace.detail.sessionMakeShared': 'Share with workspace members',
  'workspace.detail.sessionMakePrivate': 'Make private (creator only)',
  ...
  'workspace.detail.sessionRenameError': 'Failed to rename session',
  'workspace.detail.sessionDelete': 'Delete session',
  'workspace.detail.sessionDeleteConfirmTitle': 'Delete this session?',
  'workspace.detail.sessionDeleteConfirmDescription':
    'Session "{title}" and all its messages will be permanently deleted.',
  'workspace.detail.sessionDeleted': 'Session deleted',
  'workspace.detail.sessionDeleteError': 'Failed to delete session',
  'workspace.detail.hardDeleteTitle': 'Delete workspace permanently',
  'workspace.detail.hardDeleteDescription':
    'Removes the workspace together with every session, message and memory it contains. This cannot be undone.',
  'workspace.detail.hardDeleteButton': 'Delete permanently',
  ...
  'config.sections.workspaces.description':
    'Manage your workspaces — long-lived environments that scope sessions, memories, and containers.',
  'config.sections.workspaces.title': 'Workspaces',
  ...
  'config.trace.completedAt': 'Completed {time}',
  'config.trace.copyId': 'Copy trace ID',
  'config.trace.eventsOrdered.one': '{count} event, ordered by start time',
  'config.trace.eventsOrdered.other': '{count} events, ordered by start time',
  'config.trace.failureCount.one': '{count} failure',
  'config.trace.failureCount.other': '{count} failures',
  'config.trace.finishReason': 'finish: {reason}',
  'config.trace.inProgress': 'in progress',
  'config.trace.kind.model': 'model',
  'config.trace.kind.review': 'review',
  'config.trace.kind.tool': 'tool',
  'config.trace.loadDetailFailed': 'Failed to load trace',
  'config.trace.loadListFailed': 'Failed to load traces',
  'config.trace.loadingDetail': 'Loading trace',
  'config.trace.loadingList': 'Loading traces',
  'config.trace.metric.duration': 'Duration',
  'config.trace.metric.model': 'Model',
  'config.trace.metric.reviews': 'Reviews',
  'config.trace.metric.started': 'Started',
  'config.trace.metric.tools': 'Tools',
  'config.trace.modelCount.one': '{count} model',
  'config.trace.modelCount.other': '{count} models',
  'config.trace.modelStep': 'Model step',
  'config.trace.modelStepNumber': 'Model step {step}',
  'config.trace.noEvents': 'No persisted events for this trace',
  'config.trace.noTraces': 'No traces found',
  'config.trace.outputTruncated': 'output truncated',
  'config.trace.refresh': 'Refresh traces',
  'config.trace.searchLabel': 'Search traces',
  'config.trace.searchPlaceholder': 'Search trace ID or session',
  'config.trace.securityReview': 'Security review {level}',
  'config.trace.selectPrompt': 'Select a trace to inspect its timeline',
  'config.trace.startedAt': 'Started {time}',
  'config.trace.status.completed': 'completed',
  'config.trace.status.failed': 'failed',
  'config.trace.status.pending': 'pending',
  'config.trace.status.running': 'running',
  'config.trace.status.stopped': 'stopped',
  'config.trace.status.unknown': 'unknown',
  'config.trace.title': 'Trace Explorer',
  'config.trace.toolCount.one': '{count} tool',
  'config.trace.toolCount.other': '{count} tools',
  ...
  'config.forms.mcp.authMode': 'Authentication',
  'config.forms.mcp.authModeNone': 'None (public)',
  ...
  'config.forms.mcp.oauthAuthorizeUrl': 'Authorize URL',
  'config.forms.mcp.oauthTokenUrl': 'Token URL',
  'config.forms.mcp.oauthRevokeUrl': 'Revoke URL (RFC 7009)',
  'config.forms.mcp.oauthScope': 'Scopes (space-separated)',
  'config.forms.mcp.oauthResource': 'Resource (RFC 8707)',
  'config.forms.mcp.oauthConnect': 'Connect',
  'config.forms.mcp.oauthRevoke': 'Disconnect',
  'config.forms.mcp.oauthHint':
    'Tokens are stored encrypted in the Vault. The callback redirect URI must be registered at the provider as the URL shown below.',
  ...
  'config.forms.mcp.testButton': 'Test',
  'config.forms.mcp.testOk': 'Connected — {count} tools available',
  'config.forms.mcp.testFailed': 'Test failed',
  ...
  'toast.accessDenied': 'Only admins can save global configuration.',
  'toast.attachment.addFailed': 'Failed to add attachment, please try again.',
  'toast.attachment.uploadFailed': 'Something went wrong, please try again!',
  'toast.audit.markAllRead.failed': 'Failed to mark all as read',
  'toast.audit.markAllRead.success': 'All marked as read',
  'toast.audit.markRead.failed': 'Failed to mark as read',
  'toast.audit.markRead.success': 'Marked as read',
  'toast.clipboard.copied': 'Copied to clipboard!',
  'toast.config.saved': 'Configuration saved',
  'toast.config.savedBrowser': 'Settings saved to browser',
  'toast.config.saveFailed': 'Failed to save settings',
  'toast.config.validationFailed': 'Configuration validation failed',
  'toast.decision.answer.failed': 'Submission failed',
  'toast.decision.answer.timeout': 'Question timed out',
  'toast.decision.answered': 'Answered',
  'toast.decision.branch.selected': 'Option selected',
  'toast.decision.branch.timeout': 'Branch decision timed out',
  'toast.decision.conflict.resolved': 'Conflict resolved',
  ...
  'toast.decision.submitFailed': 'Submission failed',
  'toast.decision.timeout': 'Decision timed out',
  'toast.decision.timeNeeded': 'Please enter a time',
  'toast.generic.failed': 'Operation failed',
  'toast.generic.unexpected': 'Something went wrong, please try again!',
  'toast.header.jsonInvalid': 'Headers JSON is invalid',
  'toast.kb.created': 'Knowledge base created',
  'toast.kb.deleted': 'Knowledge base deleted',
  'toast.kb.priorityUpdated': 'Knowledge priority updated',
  'toast.l0rule.created': 'L0 rule created',
  'toast.l0rule.deleted': 'L0 rule deleted',
  'toast.l0rule.failedCreate': 'Failed to create L0 rule',
  'toast.l0rule.failedDelete': 'Failed to delete L0 rule',
  'toast.l0rule.failedUpdate': 'Failed to update L0 rule',
  'toast.l0rule.updated': 'L0 rule updated',
  'toast.memory.builtinLoadFailed': 'Failed to load builtin memories',
  'toast.memory.created': 'Memory created',
  'toast.memory.createFailed': 'Failed to create memory',
  'toast.memory.deleted': 'Memory deleted',
  'toast.memory.deleteFailed': 'Failed to delete memory',
  'toast.memory.longTermLoadFailed': 'Failed to load long-term memories',
  'toast.message.regenerateFailed': 'Failed to regenerate response',
  'toast.message.reverted': 'Reverted to this message',
  'toast.message.revertFailed': 'Failed to revert',
  'toast.notification.needSessionId': 'Enter a session ID',
  'toast.notify.promptEmpty': 'Prompt cannot be empty',
  'toast.notify.runDateInvalid': 'Invalid run date',
  'toast.notify.runTimeRequired': 'Delay task requires a run time',
  'toast.pair.noneActive': 'No active pairing found.',
  'toast.pair.unpairFailed': 'Failed to unpair.',
  'toast.session.abortFailed': 'Failed to abort',
  'toast.session.aborted': 'Session aborted',
  'toast.session.pinFailed': 'Failed to pin session',
  ...
  'toast.soul.fileLoaded': 'SOUL.md file loaded',
  'toast.soul.globalLoadFailed': 'Failed to load SOUL',
  'toast.soul.invalidFile': 'Please upload a .md file',
  'toast.soul.saved': 'SOUL.md saved',
  'toast.soul.saveFailed': 'Failed to save SOUL.md',
  'toast.soul.sessionLoadFailed': 'Failed to load session SOUL',
  'toast.soul.sessionSaved': 'Session SOUL saved',
  'toast.soul.sessionSaveFailed': 'Failed to save session SOUL',
  'toast.soul.snippetCopied': 'agentd.toml snippet copied',
  'toast.task.deleted': 'Task deleted',
  'toast.task.deleteFailed': 'Failed to delete task',
  'toast.task.scheduleLoadFailed': 'Failed to load schedule tasks',
  'toast.task.updated': 'Task updated',
  'toast.user.created': 'User created',
  'toast.user.rolesUpdated': 'Roles updated',
  'toast.auth.signOutFailed': 'Failed to sign out. Please try again.',
  'toast.doc.deleted': 'Document deleted',
  'toast.doc.imported': 'Document imported',
  'toast.file.loadFailed': 'Failed to load file',
  'toast.file.listLoadFailed': 'Failed to load files.',
  'toast.file.listLoadMoreFailed': 'Failed to load more files.',
  'toast.summary.loadFailed': 'Failed to load session summaries',
  ...
  'form.label.fullResult': 'Full Result',
  'form.label.error': 'Error',
  'form.label.schedule': 'Schedule',
  'form.label.totalTasks': 'Total Tasks',
  'form.label.scheduled': 'Scheduled',
  'form.label.archived': 'Archived',
  'form.label.daily': 'Daily',
  'form.label.nextRun': 'Next Run',
  'form.label.lastTriggered': 'Last Triggered',
  'form.label.scheduleRun': 'Schedule Run',
  'form.label.lastChatRun': 'Last Chat Run',
  'form.label.title': 'Title',
  'form.label.status': 'Status',
  'form.label.taskType': 'Task Type',
  'form.label.runAt': 'Run At',
  'form.label.dailyTime': 'Daily Time',
  'form.label.timezone': 'Timezone',
  'form.label.prompt': 'Prompt',
  'form.label.directDaemon': 'Direct daemon',
  'form.label.registeredNodes': 'Registered nodes',
  'form.label.webExecution': 'Web execution',
  'form.label.cpu': 'CPU',
  'form.label.mem': 'Mem',
  'form.label.disk': 'Disk',
  'form.label.tasks': 'Tasks',
  'form.label.sandboxes': 'Sandboxes',
  'form.label.systemStatus': 'Status',
  'form.label.version': 'Version',
  'form.label.uptime': 'Uptime',
  'form.label.sandboxType': 'Sandbox type',
  'form.label.cpuCores': 'CPU cores',
  'form.label.memory': 'Memory',
  'form.label.pidsLimit': 'PIDs limit',
  'form.label.maxParallelSubagents': 'Max parallel subagents',
  'form.label.diskQuota': 'Disk quota',
  'form.placeholder.morningBrief': 'Morning brief',
  ...
  'form.label.notifications': 'Notifications',
  'form.label.skills': 'Skills',
  'form.label.taskHistory': 'Task History',
  'form.label.sendVoiceReplies': 'Send voice replies',
  'form.label.url': 'URL',
  'form.placeholder.optionalNote': 'Optional note',
  'form.placeholder.allAgents': 'All Agents',
  'form.placeholder.sessionId': 'Session ID',
  'form.placeholder.filterBySessionId': 'Filter by session ID',
  ...
  'workspace.nodeBound': 'Node: {node}',
  'workspace.nodeUnbound': 'No node bound',
  'workspace.rename': 'Rename',
  'workspace.renameTitle': 'Rename workspace',
  'workspace.renameSuccess': 'Workspace renamed',
  'workspace.renameError': 'Failed to rename workspace',
  'workspace.setDefault': 'Set as default',
  'workspace.setDefaultSuccess': 'Default workspace updated',
  'workspace.setDefaultError': 'Failed to set default workspace',
  'workspace.archive': 'Archive',
  'workspace.archiveConfirmTitle': 'Archive this workspace?',
  'workspace.archiveConfirmDescription':
    '"{name}" will be archived. Its sessions and memories are kept, but it will no longer accept new tasks. This cannot be undone.',
  'workspace.archiveSuccess': 'Workspace archived',
  'workspace.archiveError': 'Failed to archive workspace',
  'workspace.archiveDefaultBlocked':
    'The default workspace cannot be archived. Set another workspace as default first.',
  'workspace.container.notCreated': 'Not created',
  'workspace.container.unreachable': 'Node offline',
  'workspace.container.unknown': 'Unknown',
  'workspace.node.online': 'Online',
  'workspace.node.offline': 'Offline',
  'workspace.detail.title': 'Workspace details',
  'workspace.detail.back': 'Back to workspaces',
  'workspace.detail.basicInfo': 'Basic info',
  'workspace.detail.name': 'Name',
  'workspace.detail.status': 'Status',
  'workspace.detail.statusActive': 'Active',
  'workspace.detail.statusArchived': 'Archived',
  'workspace.detail.createdAt': 'Created at',
  'workspace.detail.updatedAt': 'Updated at',
  'workspace.detail.node': 'Bound node',
  'workspace.detail.nodeGeneration': 'Node generation',
  'workspace.detail.containerStatus': 'Container status',
  'workspace.detail.lastHeartbeat': 'Last heartbeat',
  'workspace.detail.failoverHistory': 'Failover history',
  'workspace.detail.noFailovers': 'No failovers recorded',
  'workspace.detail.dangerZone': 'Danger zone',
  'workspace.detail.migrateTitle': 'Migrate workspace container',
  'workspace.detail.migrateDescription':
    'The container binding will be cleared and the node generation bumped. Any stale container on the old node self-destructs on its next lock check, and the next task lazily re-creates the container on a healthy node. Running tasks may be interrupted.',
  'workspace.detail.migrateButton': 'Migrate / rebind node',
  'workspace.detail.migrateSuccess': 'Workspace node binding reset',
  'workspace.detail.migrateError': 'Failed to migrate workspace node',
  'workspace.detail.loadError': 'Failed to load workspace',
  'workspace.detail.notFound': 'Workspace not found',
  'workspace.publicBadge': 'Public',
  'workspace.privateBadge': 'Private',
  'workspace.sharedBy': 'Shared by {name}',
  'workspace.setPublic': 'Make public',
