export const enUS = {
  ...
  'slash.command.start.description': 'Show welcome message and available commands',
  ...
  'cmd.session.switch.imOnly': 'Session switching is only available for IM threads.',
  'cmd.session.list.imOnly': 'Session listing is only available for IM threads.',
  'cmd.session.delete.imOnly': 'Session deletion is only available for IM threads.',
  'cmd.session.notFound': 'No matching session found for "{args}". Use /sessions to list recent sessions.',
  'cmd.session.switched': 'Switched to session {sessionId}.',
  'cmd.session.noActive': 'No session is currently bound to this thread.',
  'cmd.session.deleteNotAllowed': 'You can only delete sessions that belong to this IM account.',
  'cmd.session.deleted': 'Deleted session {sessionId}.',
  'cmd.session.cleanupSummary': 'workflow_cancelled={workflowCancelled}\ndaemon_aborted={daemonAborted}\nsandbox_stopped={sandboxStopped}\nschedule_runs_cancelled={scheduleRunsCancelled}',
  ...
  'cmd.compact.started': 'Compaction requested. The session will be summarized on the next turn.',
  ...
  'cmd.cancel.ok': 'Cancelled the current request.',
  'cmd.reset.ok': 'Session state reset. Pending approvals cleared.',
  'cmd.reset.noSession': 'No active session to reset.',
  'cmd.retry.noFailed': 'No failed request to retry.',
  ...
  'pair.success': 'Successfully bound this IM account to ClawLess user "{userId}".',
  'pair.failed': 'Failed to bind: {error}',
  'pair.usage': 'Usage: /pair <code>',
  'pair.unpairSuccess': 'Unbound this IM account from ClawLess user "{userId}".',
  'pair.unpairFailed': 'Failed to unbind: {error}',
  'pair.notBound': 'This IM account is not bound to any ClawLess user.',
  'bot.accessDenied.text': 'Access denied: your account is not allowed to use this bot.',
