...
import type { TaskSummaryRecord } from '@/lib/core/db/agentd';
...
function buildTidyPrompt(summary: TaskSummaryRecord) {
...
export async function generateTaskTidyReport(summary: TaskSummaryRecord) {
