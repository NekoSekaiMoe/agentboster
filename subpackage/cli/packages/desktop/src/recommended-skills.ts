...
export const RECOMMENDED_SKILLS: RecommendedSkillDefinition[] = [
  {
    ...
    description:
      'Create or update prompt templates and Agent skills from a short user brief. Stages commands in chat; nothing runs automatically.',
  ...
  },
  {
    ...
    setupHint:
      'Set BRAVE_API_KEY and run npm install in the skill folder before first use.',
  },
  {
    id: 'browser-tools',
    name: 'Browser Tools',
    ...
    setupHint:
      'Run npm install in the skill folder, then start Chrome with remote debugging when needed.',
  },
  {
    ...
    publisher: 'first-party',
    openUrl:
      'https://github.com/badlogic/pi-skills/tree/main/youtube-transcript',
    setupHint:
      'Run npm install in the skill folder; video captions/transcript must be available.',
  },
];
