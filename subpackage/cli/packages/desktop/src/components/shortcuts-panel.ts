...
const SHORTCUTS: Shortcut[] = [
  { keys: ['Ctrl/Cmd+N'], description: 'New session', category: 'Session' },
  {
    ...
    description: 'Open sessions browser',
    category: 'Session',
  },
  {
  ...
  {
    keys: ['/'],
    description: 'Open command palette (when editor not focused)',
    category: 'Navigation',
  },
  {
    keys: ['Ctrl+`', 'Cmd+Alt+T'],
  ...
  {
    keys: ['Enter'],
    description: 'Send message / steer when streaming',
    category: 'Input',
  },
  {
    keys: ['Alt+Enter'],
  ...
  },
  {
    ...
    description: 'Copy exported HTML to clipboard',
    category: 'Utility',
  },
  {
    keys: ['Ctrl/Cmd+,'],
