...
export class ModelSelector {
  ...
  private applyFilter(): void {
    ...
    this.filteredModels.sort((a, b) => {
      const aCurrent =
        a.id === this.currentModelId && a.provider === this.currentProvider;
      const bCurrent =
        b.id === this.currentModelId && b.provider === this.currentProvider;
  ...
  private scrollSelectedIntoView(): void {
    requestAnimationFrame(() => {
      const item = this.container.querySelector(
        `[data-model-index="${this.selectedIndex}"]`,
      );
			...
			<div class="model-selector-overlay">
              ...
              this.isLoading
                ...
                : this.filteredModels.length === 0
                  ...
                  : this.filteredModels.map((m, i) =>
                      this.renderModelItem(m, i),
                    )
            }
					</div>
