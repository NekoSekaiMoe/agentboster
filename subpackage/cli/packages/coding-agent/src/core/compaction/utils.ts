...
import type { Message } from '@agentboster-cli/ai';
...
// ============================================================================
// Summarization System Prompt (re-export from shared core)
// ============================================================================

export { SUMMARY_SYSTEM_PROMPT as SUMMARIZATION_SYSTEM_PROMPT } from './core.ts';
