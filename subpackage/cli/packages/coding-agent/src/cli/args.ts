...
${chalk.bold('Commands:')}
  ${APP_NAME} login                     Authenticate with the Agentboster server
...
${chalk.bold('Examples:')}
  ...
  ${APP_NAME} --export ~/.config/agentboster/agent/sessions/--path--/session.jsonl
  ${APP_NAME} --export session.jsonl output.html

${chalk.bold('Environment Variables:')}
  ${ENV_AGENT_DIR.padEnd(32)} - Config directory (default: ~/.config/agentboster/agent)
