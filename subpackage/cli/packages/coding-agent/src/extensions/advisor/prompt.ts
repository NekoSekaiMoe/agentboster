 ...
 *
 * Ported verbatim from @juicesharp/rpiv-advisor (prompts/advisor-system.txt).
 * Inlined as a string constant rather than read from disk so this module is
 * safe to bundle into the compiled Bun binary — the loader has no filesystem
 * asset to resolve.
 */
